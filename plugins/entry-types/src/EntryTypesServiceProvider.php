...
class EntryTypesServiceProvider extends ServiceProvider
{
    ...
    {
        /**
         * Register short-form entry types.
         *
         * @param  array  $types Registered entry types.
         */
        ...
        /**
         * Add ActivityPub support for short-from entry types.
         *
        ...
        /**
         * Autogenerate titles for "short-form" entry types.
         *
